  ...
  import { useAdmin } from '../services/useAdmin'; // Tu hook de login de admins
...
import { useAdminAuthHandler } from '../hooks/states/AdminAuthHandler';
  ...
  try {
    ...
    if (!role || !validado || role !== 'ADMIN' || validado !== 'true') {
      setLocalError('Acceso solo a administradores');
      return;
    }

    navigate('/admin/home');
  } catch {
    // El error ya es manejado por loginWithEmail (hook)
  }
};
